...
export default function InstallButton() {
	...
	return (
		<button
			...
			className="flex items-center gap-2 rounded-full bg-rose-light border border-logo px-4 py-2 text-sm font-medium text-logo hover:scale-103 transition-all duration-300 shadow-md hover:shadow-lg cursor-pointer"
